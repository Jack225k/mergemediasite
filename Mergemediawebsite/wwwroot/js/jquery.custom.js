...
$(document).ready(function () {
	...
	$('.select__field').change(function() {
	   var current = $('.select__field').val();
	   if (current != 'null') {
		   $('.select__field').css('color','#000000');
	   } else {
		   $('.select__field').css('color','#a8a8a8');
	   }
	}); 
	
	$('.input__field--date').change(function() {
	   var current = $('.input__field--date').val();
	   if (current != 'null') {
		   $('.input__field--date').css('color','#000000');
	   } else {
		   $('.input__field--date').css('color','#a8a8a8');
	   }
	}); 
